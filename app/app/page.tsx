                        ...
                        {product.demoStatus?.hasUsed && (
                          <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg p-3">
                            <div className="flex items-start space-x-2">
                              ...
                              <div className="flex-1">
                                <p className="text-sm text-gray-900 dark:text-white font-medium">Демо-доступ использован</p>
                        ...
                        {product.demoStatus?.isActive && (
                          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg p-3">
                            <div className="flex items-start space-x-2">
                              ...
                              <div className="flex-1">
                                <p className="text-sm text-blue-800 dark:text-blue-100 font-medium">Активный демо-доступ</p>
