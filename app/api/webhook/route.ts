  ...
  try {
    ...
    if (update.message) {
      ...
      if (text === '/start') {
        await sendMessage(
          chatId,
          '<b>👋 Добро пожаловать в Smit Finance!</b>\n\n' +
          'Вы нашли правильную дверь. За ней — эксклюзивный контент и аналитика от Сергея Смита и его команды.\n\n' +
          'Мы здесь, чтобы глубоко анализировать рынки, делиться инсайтами и принимать взвешенные финансовые решения. Это подписка для тех, кто ценит качество информации, а не ее количество.\n\n' +
          'Да, это тот самый "закрытый клуб", о котором вы, возможно, слышали. Вход платный, но, в отличие от покупки очередного "успешного успеха", эта инвестиция имеет все шансы окупиться. 😉\n\n' +
          'Готовы войти?\n\n' +
          '<b>📱 Ваш пропуск здесь:</b> Нажмите кнопку ниже, чтобы открыть Mini App и выбрать свой уровень доступа.',
          {
            reply_markup: {
              inline_keyboard: [[
                {
